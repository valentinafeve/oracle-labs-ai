...
![runscript-img.png](AI%20Private%20Agent%20Factory/runscript-img.png)
...
![datasource.png](AI%20Private%20Agent%20Factory/datasource.png)
...
![player_table.png](AI%20Private%20Agent%20Factory/player_table.png)
...
- Description:
```text
Este agente analiza la tabla `player_stats` para responder consultas de rendimiento ofensivo por jugador y equipo.
```
- Help description:
